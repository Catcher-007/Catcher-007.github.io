...
const canvas = $('c');
const ui = { count:$('count'),cv:$('cv'),speed:$('speed'),sv:$('sv'),attr:$('attr'),av:$('av'),reset:$('reset'),sound:$('sound'),mc:$('mc'),mcv:$('mcv'),ms:$('ms'),msv:$('msv'),ma:$('ma'),mav:$('mav'),mreset:$('mreset'),toggle:$('toggle'),mp:$('mp'),fs:$('fs'),fps:$('fps'),sim:$('sim'),tip:$('tip') };
...
ui.sound?.addEventListener('click',()=>{const m=audio.toggleMute();ui.sound.textContent=m?'🔇 静音':'🔊 声音'});
